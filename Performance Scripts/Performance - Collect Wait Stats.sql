/*
Name:	Collect Wait Stats
Source: Paul Randal
URL:	http://www.sqlskills.com/blogs/paul/wait-statistics-or-please-tell-me-where-it-hurts/
*/

-- Get most of all waits.
WITH [Waits] AS (
	SELECT
        [wait_type],
