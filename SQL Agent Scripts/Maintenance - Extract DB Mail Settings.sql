/***********************************************************************************************************************************************
= Script Name: Get DB Mail settings from the server.sql

= Purpose:
Extracts DB mail settings from SQL.

= Notes:
- ACOSTA - 2013-02-15 = Created.
***********************************************************************************************************************************************/
...
GO
EXEC master.dbo.xp_instance_regwrite N''HKEY_LOCAL_MACHINE'', N''SOFTWARE\Microsoft\MSSQLServer\SQLServerAgent'', N''DatabaseMailProfile'', N''REG_SZ'', N''' + p.name + '''
GO
